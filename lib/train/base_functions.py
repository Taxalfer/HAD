...
# datasets related
from lib.train.dataset import EventVOT ,Coesot, VisEvent # FE108
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        ...
        if name == "COESOT":
            datasets.append(Coesot(settings.env.coesot_dir, image_loader=image_loader))
        if name == "COESOT_VAL":
            datasets.append(Coesot(settings.env.coesot_val_dir, image_loader=image_loader))
        # if name == "FE108":
